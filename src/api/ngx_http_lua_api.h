...
ngx_int_t ngx_http_lua_shdict_api_fun(ngx_shm_zone_t *shm_zone,
    ngx_str_t key, ngx_http_lua_get_fun_t fun, int64_t exptime,
        void *userctx);
...
typedef ngx_int_t (*ngx_http_fun_t)(ngx_str_t zkey, ngx_http_lua_value_t *value,
    void *userctx);
